...
public class ProductDAO {
    ...
    public static final String COL_EXPORATION = "expired";
    ...
    public boolean insertProduct(Product product) {
        ...
        contentValues.put(COL_EXPORATION, product.dateExpiration);
    ...
    public List<Product> getAllProduct() {
        ...
        if (cursor.getCount() > 0) {
            ...
            while (!cursor.isAfterLast()) {
                ...
                product.dateExpiration = cursor.getString(cursor.getColumnIndex(COL_EXPORATION));
