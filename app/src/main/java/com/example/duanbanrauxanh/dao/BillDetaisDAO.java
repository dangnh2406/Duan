...
public class BillDetaisDAO {
    ...
    public static final String COL_BUY_ACOUNT = "buyAcount";
    ...
    public boolean insertBildetai(BillDetai billDetai) {
        ...
        contentValues.put(COL_BUY_ACOUNT, billDetai.buyAcount);
    ...
    public List<BillDetai> getAlList(String id) {
        ...
        String query = "select " + BillDAO.TABLE_BILL + "." + BillDAO.COL_ID_BILL + " , " + ProductDAO.TABLE_NAME + "."
                ...
                " , " + BillDetaisDAO.TABLE_BILL_DETAIS + "." + BillDetaisDAO.COL_BUY_ACOUNT + " , " + BillDetaisDAO.TABLE_BILL_DETAIS + "."
        ...
        if (cursor.getCount() > 0) {
            ...
            while (!cursor.isAfterLast()) {
                ...
                billDetai.setBuyAcount(cursor.getDouble(cursor.getColumnIndex(BillDetaisDAO.COL_BUY_ACOUNT)));
