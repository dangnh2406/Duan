...
public class BillAdapter extends BaseAdapter {
    ...
    public BillAdapter(Context context, List<Bill> list, com.example.duanbanrauxanh.interFace.onItemClickBill onItemClickBill) {
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            ...
            viewHoder = (BillAdapter.ViewHoder) view.getTag();
        }
        ...
        viewHoder.edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                update(view, bill);
                loadToList();
